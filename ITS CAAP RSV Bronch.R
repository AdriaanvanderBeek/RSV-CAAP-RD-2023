...
##RSV bronchiolitis <12m
mod.rsv.bronch.12 <- step_func(ds=ds1, outcome_name='rsv.bronch.cases.12', denom='pop.12', mod='negbin', other.covars='none')
mod.rsv.bronch.12_t <- step_func(ds=ds1, outcome_name='rsv.bronch.cases.12', denom='pop.12', mod='negbin', other.covars='time_index')

  ###favors model without trend
  mod.rsv.bronch.12$aic1
  mod.rsv.bronch.12_t$aic1
